...
function App() {
  ...
  <div className="flex-none gap-2">
   ...
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" /></svg>
    ...
    {/* <div className="navbar bg-base-100 max-w-7xl m-auto mt-8 flex justify-around">
      <div className="navbar-start">
        ...
        <a className="btn btn-ghost text-xl lg:text-3xl font-bold">Flavorful Fusions</a>
      </div>
      ...
      <label className="input hidden lg:flex items-center gap-2 rounded-3xl bg-[#150B2B0D]">
        <p className='text-2xl'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" /></svg></p>
      
  <input type="text" className="grow font-normal text-[#150B2BB3] text-lg" placeholder="Search" />
  </label>
     <img className='bg-[#0BE58A] rounded-full' src="https://i.ibb.co/pX03SVM/Frame.png" alt="" />
      </div>
    </div> */}
